        ...
        _drop_none(
            {
                ...
                "localOnly": raw.get("local_only", raw.get("localOnly", True)),
                "dataRoot": raw.get("data_root", raw.get("dataRoot")),
                "indexedItems": raw.get("indexed_items", raw.get("indexedItems", 0)),
                "indexedSources": raw.get("indexed_sources", raw.get("indexedSources", 0)),
                "catalogedSessions": raw.get("cataloged_sessions", raw.get("catalogedSessions", 0)),
                "indexedCatalogSessions": raw.get(
                    "indexed_catalog_sessions",
                    raw.get("indexedCatalogSessions"),
                ),
                "pendingCatalogSessions": raw.get(
                    "pending_catalog_sessions",
                    raw.get("pendingCatalogSessions", 0),
                ),
                "failedCatalogSessions": raw.get(
                    "failed_catalog_sessions",
                    raw.get("failedCatalogSessions", 0),
                ),
                "staleCatalogSessions": raw.get(
                    "stale_catalog_sessions",
                    raw.get("staleCatalogSessions", 0),
                ),
            }
        ),
    )
