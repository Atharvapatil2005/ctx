...
class CtxMemoryError(Exception):
    """Base class for ctx memory SDK errors."""
...
class CtxMemoryCliError(CtxMemoryError):
...
class CtxMemoryTimeoutError(CtxMemoryError):
...
class HostedTransportNotImplementedError(CtxMemoryError):
