"""Typed memory-v1 envelope shapes exposed by the Python SDK."""
...
class _MemoryErrorRequired(TypedDict):
    code: MemoryErrorCode
    message: str
    retryable: bool


class MemoryErrorPayload(_MemoryErrorRequired, total=False):
    details: JsonObject
    cause: Optional[str]
...
StatusResponse = TypedDict(
    "StatusResponse",
    {
        "contractVersion": Literal["memory-v1"],
...
ErrorResponse = TypedDict(
    "ErrorResponse",
    {
        ...
        "backend": Backend,
        "error": MemoryErrorPayload,
    },
)

MemoryResponse = Union[
    StatusResponse,
    InitResponse,
    SourcesResponse,
    ImportResponse,
