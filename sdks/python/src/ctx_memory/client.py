...
from .transport import HostedAdapter, LocalCliAdapter, MemoryTransport
from .types import (
    ImportResponse,
    InitResponse,
    JsonObject,
...
class MemoryClient:
    ...
    @classmethod
    def hosted(cls, config: HostedConfig) -> "MemoryClient":
        return cls(HostedAdapter(config))

    @classmethod
    def from_config(cls, config: Union[LocalConfig, HostedConfig]) -> "MemoryClient":
    ...
    @property
    def transport(self) -> MemoryTransport:
