...
/** Typed builders for memory-v1 operations. */
public final class MemoryOptions {
    ...
    public static ImportMemory importMemory() {
    ...
    public static final class ImportMemory {
        ...
        public ImportMemory all(boolean all) {
            this.all = all;
            return this;
        }

        public ImportMemory provider(String provider) {
            this.provider = provider;
            return this;
        }

        public ImportMemory path(String path) {
            this.path = path;
            return this;
        }

        public ImportMemory path(Path path) {
            this.path = path == null ? null : path.toString();
            return this;
        }

        public ImportMemory resume(boolean resume) {
            this.resume = resume;
            return this;
        }

        public ImportMemory progress(String progress) {
            this.progress = progress;
            return this;
        }
    }
