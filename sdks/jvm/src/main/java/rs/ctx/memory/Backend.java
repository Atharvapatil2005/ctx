...
/** Backend metadata for a memory-v1 response. */
public final class Backend {
    ...
    Backend(Map<String, Object> fields) {
        this.kind = MemoryValue.string(fields.get("kind"));
        this.dataRoot = MemoryValue.string(fields.get("dataRoot"));
        this.baseUrl = MemoryValue.string(fields.get("baseUrl"));
        this.fields = MemoryValue.copyObject(fields);
    }
